...
layout: post
title: Project code
summary: This is the code for our power estimator project. It concludes both SystemVerilog code for hardware implementation on the FPGA and C code for user interface and VGA control.
